...
public class ReceiptService {
    ...
    public ReceiptResponse getById(UUID id) {
        Receipt receipt = receiptRepository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Receipt not found: " + id));
    ...
    private List<MercadonaItem> toMercadonaItems(Receipt receipt, List<ParsedReceipt.ParsedItem> items) {
        return items.stream()
